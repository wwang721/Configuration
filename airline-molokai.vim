...
if get(g:, 'airline_molokai_bright', 0)
  let s:N2 = [ '#f8f8f0' , '#000000' , 253 , 208 ] " info
else
  let s:N2 = [ '#f8f8f0' , '#000000' , 253 , 16 ] " info
endif
let s:N3 = [ '#f8f8f0' , '#6188ad' , 253 , 67  ] " statusline
...
if get(g:, 'airline_molokai_bright', 0)
  let s:I2 = [ '#f8f8f0' , '#000000' , 253 , 208 ]
else
  let s:I2 = [ '#f8f8f0' , '#000000' , 253 , 16 ]
endif
let s:I3 = [ '#f8f8f0' , '#6188ad' , 253 , 67  ]
...
if get(g:, 'airline_molokai_bright', 0)
  let s:R2 = [ '#f8f8f0' , '#000000' , 253 , 208 ]
else
  let s:R2 = [ '#f8f8f0' , '#000000' , 253 , 16 ]
endif
let s:R3 = [ '#f8f8f0' , '#6188ad' , 253 , 67  ]
...
if get(g:, 'airline_molokai_bright', 0)
  let s:V2 = [ '#f8f8f0' , '#000000' , 253 , 208 ]
else
  let s:V2 = [ '#f8f8f0' , '#000000' , 253 , 16 ]
endif
let s:V3 = [ '#f8f8f0' , '#6188ad' , 253 , 67  ]
